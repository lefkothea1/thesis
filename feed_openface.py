...
# input_path = 'G:\\lefs_cut_vids\\pp02_neutral.mkv'  # or 'C:/path/to/input/video.mp4' wont work in different paths except the openface dir
input_vid = 'pp02_neutral.mkv'  # or 'C:/path/to/input/video.mp4'
...
# command = 'FeatureExtraction.exe -f "{input_path}" -out_dir "{output_dir}"'
