...
**It’s a measure for how much variation there exists in the heart rate. 
...
#to convert time columns to dates and times noy used anymore
...
#calculating RR successive differences  ----should leave out the first alnd last 2 min
