...
# pd.DataFrame(data).to_csv(input_file[:-4] + ".csv")
# print("i saved something")


# #     ###ALL OF THESE HAVE TO BE STRINGS ###
# csv_file ='2023-04-11 10-30-43.csv'
# activity_name = "PP2_testBlock_HRV"
#start_time_activity = "05:"
# #end_time_activity = 
